...
async function extractError(r7) {
  const ret = { ok: false, status: r7.status };
  try {
  ...
  ret.error = r7.statusText || `Unknown error ${r7.status}`;
  return ret;
}
...
var PinkgillNav = class extends h3 {
  #profile = new import_lit114.StoreController(this, profile.store);
  ...
  render() {
    ...
    const loggedIn = !!p2?.data && !p2.loading;
