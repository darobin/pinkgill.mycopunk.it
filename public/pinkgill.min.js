...
var PinkgillCreateTileDialog = class extends h3 {
  ...
  #controller = new import_lit125.MultiStoreController(this, [this.#uploaderData.$uploadDone, this.#uploaderData.$uploadLoading, this.#uploaderData.$uploadError, $uiTileOverlayOpen]);
...
// client/el/installed-palette.js
var PinkgillInstalledPalette = class extends (0, import_lit127.withStores)(h3, [$installs, $installsError, $installsLoading]) {
  static styles = [
    i`
      :host {
        display: block;
...
var import_lit129 = __toESM(require_lib(), 1);
...
var PinkgillInstall = class extends h3 {
  ...
  #installerData = makeInstaller();
  #controller = new import_lit129.MultiStoreController(this, [
    // this.#storeData.$manifest,
    // this.#storeData.$manifestLoading,
    // this.#storeData.$manifestError,
    this.#installerData.$installDone,
...
var PinkgillWishDialog = class extends h3 {
  ...
  #controller = new import_lit132.MultiStoreController(this, [this.#instantiationData.$instanceDone, this.#instantiationData.$instanceLoading, this.#instantiationData.$instanceError, $activeWish]);
