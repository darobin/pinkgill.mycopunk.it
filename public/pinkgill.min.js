...
var require_StoreController = __commonJS({
  "node_modules/@nanostores/lit/lib/StoreController.js"(exports) {
    ...
    exports.StoreController = StoreController5;
  }
});
...
var Resource = class {
  ...
  async load(prm) {
    ...
    const r7 = await api_default[this.#method](prm);
...
var profile = new Resource("getCurrentProfile", { available: true });
async function loadProfile() {
  await profile.load();
}
var actorProfile = new Resource("getActorProfile");
