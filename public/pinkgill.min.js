...
var require_MultiStoreController = __commonJS({
  "node_modules/@nanostores/lit/lib/MultiStoreController.js"(exports) {
    ...
    var MultiStoreController3 = class {
    ...
    exports.MultiStoreController = MultiStoreController3;
  }
});
...
async function originForTile(tile) {
...
function getCachedManifest(tile) {
  ...
  render() {
    ...
    return be(
      Promise.all(tiles.map((tile) => (async () => {
        ...
        return ke`<pg-tile .tile=${tile} data-tile-url=${url}></pg-tile>`;
      })())),
      ke`<pg-loading></pg-loading>`
    );
  }
};
