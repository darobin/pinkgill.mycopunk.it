...
var require_StoreController = __commonJS({
  "node_modules/@nanostores/lit/lib/StoreController.js"(exports) {
    ...
    exports.StoreController = StoreController3;
  }
});
...
var require_MultiStoreController = __commonJS({
  "node_modules/@nanostores/lit/lib/MultiStoreController.js"(exports) {
    ...
    var MultiStoreController4 = class {
    ...
    exports.MultiStoreController = MultiStoreController4;
  }
});
...
var require_withStores = __commonJS({
  "node_modules/@nanostores/lit/lib/withStores.js"(exports) {
    ...
    var MultiStoreController_1 = require_MultiStoreController();
    var withStores4 = (LitElementClass, atoms) => {
    ...
    exports.withStores = withStores4;
  }
});
...
function makeTileUploaderStores() {
...
// client/el/root.js
var PinkgillRoot = class extends (0, import_lit114.withStores)(h3, [$computedRoute, $uiTileOverlayOpen]) {
  static styles = [
    i`
      :host {
        display: block;
  ...
  render() {
    ...
    if (route === "home") return ke`<div class="home">
      <div class="sidebar">
...
// client/el/avatar.js
var import_lit118 = __toESM(require_lib(), 1);
var PinkgillAvatar = class extends (0, import_lit118.withStores)(h3, [$identity]) {
  static styles = [
    i`
      :host {
        display: block;
...
var PinkgillTimeline = class extends h3 {
  #timeline = new import_lit121.StoreController(this, $timeline);
  static styles = [
    i`
      :host {
        display: block;
...
var PinkgillTile = class extends h3 {
  #identity = new import_lit123.StoreController(this, $identity);
  static properties = {
...
var import_lit126 = __toESM(require_lib(), 1);
var PinkgillCreateTileDialog = class extends h3 {
  ...
  #controller = new import_lit126.MultiStoreController(this, [this.#uploaderData.$uploadDone, this.#uploaderData.$uploadLoading, this.#uploaderData.$uploadError, $uiTileOverlayOpen]);
...
var $installs = atom([]);
var $installsLoading = atom(true);
var $installsError = atom(false);
...
// client/el/installed-palette.js
var PinkgillInstalledPalette = class extends (0, import_lit128.withStores)(h3, [$installs, $installsError, $installsLoading]) {
  static styles = [
    i`
      :host {
        display: block;
  ...
  render() {
    ...
    if ($installsLoading.get()) content = ke`<pg-loading></pg-loading>`;
    else if ($installsError.get()) content = ke`<span class="error">${$installsError.get()}</span>`;
    else if ($installs.get().length) content = ke`<ul>${$installs.get().map((it) => ke`<li><pg-install .tile=${it}></pg-install></li>`)}</ul>`;
    return ke`<sl-card>
...
var $activeWish = atom({});
async function grantWish(wish2, tileURI) {
  const manifest = await getManifest(tileURI);
  console.warn(`granting`, wish2, tileURI, manifest);
  $activeWish.set({ wish: wish2, tileURI, manifest });
}
...
var PinkgillInstall = class extends h3 {
  ...
  #installerData = makeInstaller();
  #controller = new import_lit130.MultiStoreController(this, [
    // this.#storeData.$manifest,
    // this.#storeData.$manifestLoading,
    // this.#storeData.$manifestError,
    this.#installerData.$installDone,
  ...
  render() {
    ...
    const manifest = {};
    if (!manifest?.wishes) return D;
    content = ke`<sl-details summary=${manifest.name}>
      <sl-menu @sl-select=${this.handleWishMenu}>
        ${manifest.wishes.map((w2, idx) => {
      let label = "Wish";
      let icon = "magic";
...
var import_lit133 = __toESM(require_lib(), 1);
var PinkgillWishDialog = class extends h3 {
  ...
  #controller = new import_lit133.MultiStoreController(this, [this.#instantiationData.$instanceDone, this.#instantiationData.$instanceLoading, this.#instantiationData.$instanceError, $activeWish]);
  async handleGrantWish() {
    const { wish: wish2, tileURI, manifest } = $activeWish.get();
    if (wish2?.can == "instantiate") {
  ...
  render() {
    const { wish: wish2, tileURI, manifest } = $activeWish.get();
    if (wish2?.can !== "instantiate") return D;
    const err = this.#instantiationData.$instanceError.get();
    const label = "Post";
    return ke`<sl-dialog label=${manifest.name} ?open=${!!wish2} @sl-after-hide=${stopWishing}>
      <pg-tile .tile=${tileURI} .wish=${wish2}></pg-tile>
