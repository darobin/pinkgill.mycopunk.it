...
var require_StoreController = __commonJS({
  "node_modules/@nanostores/lit/lib/StoreController.js"(exports) {
    ...
    exports.StoreController = StoreController6;
  }
});
...
var PinkgillTileLoader = class extends h3 {
  ...
  render() {
    ...
    const src2 = `https://tile.${window.location.host}/.well-known/web-tiles/?cid=${this.cid}`;
    console.warn(`in <pg-tile-loader>`, src2);
    return ke`<iframe src=${src2} style=${se(style)} loading="lazy"></iframe>`;
  }
};
