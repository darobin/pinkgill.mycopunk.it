...
var PinkgillTimeline = class extends (0, import_lit121.withStores)(h3, [$timeline, $timelineError, $timelineLoading]) {
  ...
  render() {
    ...
    return tiles.map((tile, idx) => {
      const div = idx ? ke`<sl-divider></sl-divider>` : D;
      return ke`
        ${div}
...
var PinkgillTile = class extends h3 {
  ...
  render() {
    ...
    let content = ke`<pg-loading></pg-loading>`;
    let footer = D;
    if (!loading) {
      let dynHeight;
      ...
      content = ke`<iframe src=${url} style=${dynHeight ? `--dynamic-height: ${dynHeight}px` : ""}></iframe>`;
