...
// client/el/root-routes.js
var PinkgillRoot = class extends (0, import_lit113.withStores)(h3, [$computedRoute, $identity]) {
  static styles = [
    i`
      :host {
        display: block;
  ...
  render() {
    ...
    if (route === "home") return ke`home of <pre>${JSON.stringify($identity.get(), null, 2)}</pre>`;
    if (route === "404") return ke`<pg-404></pg-404>`;
  }
};
...
var PinkgillAvatar = class extends (0, import_lit117.withStores)(h3, [$identity]) {
  static styles = [
    i`
      :host {
        display: block;
