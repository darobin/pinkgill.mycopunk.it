...
var PinkgillAvatar = class extends h3 {
  ...
  render() {
    ...
    if (error) return ke`<div class="avatar"><sl-button href="/login">login</sl-button></div>`;
...
var PinkgillRoot = class extends h3 {
  #profile = new import_lit119.StoreController(this, profile.store);
  #router = new import_lit119.StoreController(this, $router);
  static styles = [
    i`
      :host {
        display: block;
...
var PinkgillProfile = class extends h3 {
  #actorProfile = new import_lit121.StoreController(this, actorProfile.store);
